...
export default function JobDetail() {
  ...
  return (
    <section>
      ...
      <div className="py-6">
        <div className="container lg:px-36 mx-auto lg:flex ">
          <div>
            <Breadcrumb>
              <Breadcrumb.Item>
            ...
            <div className="mb-4" id="overview">
              <h3 className="lg:text-3xl text-2xl text-gray-700 mt-2 font-bold">
                {jobDetail.name}
              </h3>
              <div className="flex">
                <div className="mr-5">
            ...
            <div>
              <img
                src={jobDetail.image}
                alt=""
                className="lg:h-96 w-full object-fill object-center"
              />
            </div>
                ...
                >
                  ...
                  <TabPane tab="STANDARD" key="2">
                    <div className="p-5">
                      ...
                      <p className="text-gray-500 font-semibold">
                        Create a STANDARD product ${jobDetail?.subType?.name}{" "}
                        job
                      </p>
                      <div className="text-gray-600 font-semibold mb-5">
                        <FieldTimeOutlined className="relative bottom-1 text-base" />{" "}
          ...
          <div className="w-full lg:sticky top-0 z-10 h-full ml-28 hidden lg:block">
            <div style={{ border: "1px solid #d9d9d9" }}>
              <Tabs
                defaultActiveKey="1"
                size={`medium`}
